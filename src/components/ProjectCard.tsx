...
const ProjectCard: React.FC<ProjectCardProps> = ({ title, detailsLink }) => {
  return (
    <div className="w-full max-w-4xl rounded-3xl bg-zillex-purple/20 backdrop-blur-sm p-1 
                    overflow-hidden transition-all duration-500 hover:scale-[1.02] neon-border">
      <div className="rounded-[22px] bg-gradient-to-br from-zillex-deep-purple via-zillex-purple/20 to-zillex-deep-purple 
